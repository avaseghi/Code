...
class AxiDraw(inkex.Effect):
    ...
    def readIO(self):
        ...
        if self.serial_port is not None:
          test = ebb_serial.query(self.serial_port, 'I\r')
          return test
    ...
    def moveXBack(self):
        ...
        if self.serial_port is not None:
          ebb_serial.command(self.serial_port, 'XM,50,-50,0\r')

    def moveYBack(self):
        # self.serial_connect()

        if self.serial_port is not None:
          ebb_serial.command(self.serial_port, 'XM,50,0,-50\r')
